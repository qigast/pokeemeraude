...
const u16 gBattleAnimUnusedPal_LineSketch2[] = INCGFX_U16("graphics/battle_anims/unused/line_sketch_2.pal", ".gbapal.lz");
...
const u32 gContestInterfaceAudiencePalette[] = INCGFX_U32("graphics/contest/interface.pal", ".gbapal.lz");
...
const u32 gContestResults_Pal[]                  = INCGFX_U32("graphics/contest/results_screen/tiles.pal", ".gbapal.lz");
...
const u32 gDomeTourneyTree_Pal[] = INCGFX_U32("graphics/battle_frontier/tourney_tree.pal", ".gbapal.lz");
...
const u32 gPartyMenuBg_Pal[] = INCGFX_U32("graphics/party_menu/bg.pal", ".gbapal.lz");
...
const u32 gSummaryScreen_Pal[]                = INCGFX_U32("graphics/summary_screen/tiles.pal", ".gbapal.lz");
...
const u32 gNamingScreenCursor_Gfx[]              = INCGFX_U32("graphics/naming_screen/cursor.png", ".4bpp", "-num_tiles 4 -Wnum_tiles");
const u32 gNamingScreenCursorSquished_Gfx[]      = INCGFX_U32("graphics/naming_screen/cursor_squished.png", ".4bpp", "-num_tiles 4 -Wnum_tiles");
const u32 gNamingScreenCursorFilled_Gfx[]        = INCGFX_U32("graphics/naming_screen/cursor_filled.png", ".4bpp", "-num_tiles 4 -Wnum_tiles");
...
*/
// credits
const u32 gCreditsCopyrightEnd_Gfx[] = INCGFX_U32("graphics/credits/the_end_copyright.png", ".4bpp.lz");
const u32 gCreditsCopyrightEnd_Tilemap[] = INCBIN_U32("graphics/credits/the_end_copyright.bin.lz");

const u16 g321Start_Pal[] = INCGFX_U16("graphics/link/321start.png", ".gbapal");
const u32 g321Start_Gfx[] = INCGFX_U32("graphics/link/321start.png", ".4bpp.lz");

// poke jump
const u16 gPokeJumpBonuses_Pal[] = INCGFX_U16("graphics/pokemon_jump/bonuses.png", ".gbapal");
const u32 gPokeJumpBonuses_Gfx[] = INCGFX_U32("graphics/pokemon_jump/bonuses.png", ".4bpp.lz");
const u32 gPokeJumpBonuses_Tilemap[] = INCBIN_U32("graphics/pokemon_jump/bonuses.bin.lz");

const u16 gBlenderCenter_Pal[] = INCGFX_U16("graphics/berry_blender/center.png", ".gbapal");
...
const u32 gTilesetTiles_Shop[] = INCGFX_U32("data/tilesets/secondary/shop/tiles.png", ".4bpp.lz", "-num_tiles 502");

// roulette
const u16 gRouletteShadow_Pal[] = INCGFX_U16("graphics/roulette/shadow.png", ".gbapal");
const u16 gRouletteBall_Pal[] = INCGFX_U16("graphics/roulette/ball.png", ".gbapal");
const u16 gRouletteBallCounter_Pal[] = INCGFX_U16("graphics/roulette/ball_counter.png", ".gbapal");
const u16 gRouletteCursor_Pal[] = INCGFX_U16("graphics/roulette/cursor.png", ".gbapal");
const u16 gRouletteCredit_Pal[] = INCGFX_U16("graphics/roulette/credit.png", ".gbapal");
const u16 gRouletteShroomish_Pal[] = INCGFX_U16("graphics/roulette/shroomish.png", ".gbapal");
const u16 gRouletteTaillow_Pal[] = INCGFX_U16("graphics/roulette/tailow.png", ".gbapal");
const u16 gRouletteGridIcons_Pal[] = INCGFX_U16("graphics/roulette/grid_icons.png", ".gbapal");
const u16 gRouletteWynaut_Pal[] = INCGFX_U16("graphics/roulette/wynaut.png", ".gbapal");
const u16 gRouletteAzurill_Pal[] = INCGFX_U16("graphics/roulette/azurill.png", ".gbapal");
const u16 gRouletteSkitty_Pal[] = INCGFX_U16("graphics/roulette/skitty.png", ".gbapal");
const u16 gRouletteMakuhita_Pal[] = INCGFX_U16("graphics/roulette/makuhita.png", ".gbapal");
const u16 gRouletteUnused1_Pal[] = INCGFX_U16("graphics/roulette/unused_1.pal", ".gbapal");
const u16 gRouletteUnused2_Pal[] = INCGFX_U16("graphics/roulette/unused_2.pal", ".gbapal");
const u16 gRouletteUnused3_Pal[] = INCGFX_U16("graphics/roulette/unused_3.pal", ".gbapal");
const u16 gRouletteUnused4_Pal[] = INCGFX_U16("graphics/roulette/unused_4.pal", ".gbapal");

// frontier pass
const u32 gFrontierPassMapScreen_Gfx[] = INCGFX_U32("graphics/frontier_pass/map_screen.png", ".4bpp.lz");
...
const u16 gMatchCallUI_Pal[] = INCGFX_U16("graphics/pokenav/match_call/ui.png", ".gbapal");
const u32 gMatchCallUI_Gfx[] = INCGFX_U32("graphics/pokenav/match_call/ui.png", ".4bpp.lz", "-num_tiles 13 -Wnum_tiles");
const u32 gMatchCallUI_Tilemap[] = INCBIN_U32("graphics/pokenav/match_call/ui.bin.lz");

// pokenav conditions search results
const u16 gConditionSearchResultFramePal[] = INCGFX_U16("graphics/pokenav/condition/search_results.png", ".gbapal");
const u32 gConditionSearchResultTiles[] = INCGFX_U32("graphics/pokenav/condition/search_results.png", ".4bpp.lz");
const u32 gConditionSearchResultTilemap[] = INCBIN_U32("graphics/pokenav/condition/search_results.bin.lz");

// pokenav ribbons list
const u16 gMonRibbonListFramePal[] = INCGFX_U16("graphics/pokenav/ribbons/list_bg.png", ".gbapal");
const u32 gMonRibbonListFrameTiles[] = INCGFX_U32("graphics/pokenav/ribbons/list_bg.png", ".4bpp.lz");
const u32 gMonRibbonListFrameTilemap[] = INCBIN_U32("graphics/pokenav/ribbons/list_bg.bin.lz");

// pokedex
const u16 gCryMeter_Pal[] = INCGFX_U16("graphics/pokedex/cry_meter.png", ".gbapal");
const u8 gCryMeter_Gfx[] = INCGFX_U8("graphics/pokedex/cry_meter.png", ".4bpp.lz");
