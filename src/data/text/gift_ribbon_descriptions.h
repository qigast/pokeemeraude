...
const u8 gGiftRibbonDescriptionPart1_SummerHolidays[] = _("RUBAN vacances d'été");
const u8 gGiftRibbonDescriptionPart2_EmptyString[] = _("");
const u8 gGiftRibbonDescriptionPart1_WinterHolidays[] = _("RUBAN vacances d'hiver");
...
const u8 gGiftRibbonDescriptionPart1_LoveForPokemon[] = _("RUBAN qui montre l'amour");
