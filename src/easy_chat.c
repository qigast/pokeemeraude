...
static const struct WindowTemplate sEasyChatWindowTemplates[] = {
    [WIN_TITLE] = {
        .bg = 1,
        .tilemapLeft = 0, //!< French Difference
        .tilemapTop = 0,
        .width = 30, //!< French Difference
        .height = 2,
        .paletteNum = 10,
        .baseBlock = 0x10,
    },
...
static void AddPhraseWindow(void)
{
    ...
    template.baseBlock = 0x84; //!< French Difference
...
static void AddMainScreenButtonWindow(void)
{
    ...
    template.height = 2;
    template.paletteNum = 11;
    template.baseBlock = 0x4C; //!< French Difference
...
u8 *OtherConvertEasyChatWordsToString(u8 *dest, const u16 *src, u16 columns, u16 rows)
{
    u16 i, j, k;
    u16 numColumns;
